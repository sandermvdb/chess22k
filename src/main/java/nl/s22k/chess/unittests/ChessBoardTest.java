...
public class ChessBoardTest {
	...
	public void testWhitePromotion() {
		...
		int move = MoveUtil.createPromotionMove(49, 56);
	...
	public void testBlackPromotion() {
		...
		int move = MoveUtil.createPromotionMove(14, 7);
		chessBoard.doMove(move);
	}
	...
	public void testAttackedPromotion() {
		...
		int move = MoveUtil.createPromotionAttack(49, 56, ChessConstants.ROOK);
		chessBoard.doMove(move);
	}
	...
	public void testWhiteKingCastling() {
		...
		while (MoveList.hasNext()) {
			...
			if (MoveUtil.isCastling(castlingMove)) {
