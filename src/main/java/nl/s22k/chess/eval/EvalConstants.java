...
public class EvalConstants {
	...
	public static final int[] MATERIAL_SCORES = new int[] { 0, 100, 325, 350, 500, 900, 3200 };
	...
	public static final int[] PASSED_PAWN_ENDGAME_SCORE = new int[] {0, 20, 40, 80, 120, 200, 300, 0};
